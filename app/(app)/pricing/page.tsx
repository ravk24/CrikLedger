...
// so a signed-out visitor — including a payment-gateway reviewer or a
// prospective customer — is redirected to /login and never sees a price.
// This page is the catalogue: no session reads, nothing dynamic, so it
// stays crawlable and prerendered. Do NOT add getNavState() here.
//
  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-2 rounded-lg border border-border bg-surface p-4 text-sm text-text-secondary">
        ...
        <p>
          Payments are processed securely through Razorpay. CrikLedger does not
          store card numbers, CVV, UPI credentials, or bank credentials.
        </p>
